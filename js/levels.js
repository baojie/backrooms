...
export const LEVELS = [
  { name:'黄色房间',   layout:'maze',
    wallRGB:[212,187,96],  floorRGB:[110,70,35],  ceilRGB:[180,170,140],
    ambient:0x665533, lightHex:0xfff0b8, fogHex:0x1a1505, fogNear:4,  fogFar:28, hasCeiling:true },
  { name:'车库',       layout:'parking',
    wallRGB:[120,120,124], floorRGB:[70,70,72],   ceilRGB:[90,90,92],
    ambient:0x484850, lightHex:0xc4c8b0, fogHex:0x202024, fogNear:3,  fogFar:24, hasCeiling:true, props:'cars' },
  { name:'发电厂',     layout:'industrial',
    wallRGB:[80,80,86],    floorRGB:[60,55,50],   ceilRGB:[55,55,60],
    ambient:0x303040, lightHex:0xb0d8ff, fogHex:0x10141c, fogNear:2,  fogFar:22, hasCeiling:true, props:'sparks' },
  { name:'游泳池',     layout:'open',
    wallRGB:[238,238,238], floorRGB:[232,232,230], ceilRGB:[240,238,232],
    ambient:0xb8b8b8, lightHex:0xfff8e8, fogHex:0xd6d6d4, fogNear:10, fogFar:38, hasCeiling:true, props:'water' },
  { name:'农场',       layout:'open',
    wallRGB:[140,108,70],  floorRGB:[80,140,60],   ceilRGB:[120,170,220],
    ambient:0x88aacc, lightHex:0xffeec4, fogHex:0xb6cde0, fogNear:8,  fogFar:40, hasCeiling:false, props:'crops' },
  { name:'幼儿园',     layout:'classrooms',
    wallRGB:[245,200,205], floorRGB:[200,160,180], ceilRGB:[255,240,220],
    ambient:0xa07880, lightHex:0xffd0d0, fogHex:0x402030, fogNear:3,  fogFar:20, hasCeiling:true, props:'toys' },
  { name:'办公室',     layout:'cubicles',
    wallRGB:[210,200,180], floorRGB:[80,90,100],   ceilRGB:[230,230,225],
    ambient:0x707070, lightHex:0xffffff, fogHex:0x303030, fogNear:4,  fogFar:26, hasCeiling:true, props:'cubicles' },
  { name:'图书馆',     layout:'shelves',
    wallRGB:[120,80,40],   floorRGB:[60,40,25],    ceilRGB:[80,55,35],
